/*
Adapted for object orientated implementation by Richard Steele
...
class Noise
{
    ...
    simplex2(xin, yin) {
        ...
        if(t0<0) {
            ...
            t0 *= t0;
            n0 = t0 * t0 * this.dot2(gi0, x0, y0);  // (x,y) of this.grad3 used for 2D gradient
        }
